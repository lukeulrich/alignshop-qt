...
public:
    ...
    static QVector<MpttNode> toMpttVector(ITreeNode *treeNode);
    ...
    static ITreeNode *fromMpttVector(QVector<MpttNode> &mpttNodeVector);
...
private:
    ...
    static int recurseBuildMpttVector(ITreeNode *node, int left, QVector<MpttNode> &mpttNodeVector);
