...
void TestMpttTreeConverter::toMpttVector()
{
    ...
    // Test: root + child1
    mpttNodes.clear();
    TreeNode<bool> *child1 = new TreeNode<bool>(false);
    ...
    mpttNodes.clear();
    TreeNode<bool> *child12 = new TreeNode<bool>(false);
    ...
    mpttNodes.clear();
    TreeNode<bool> *child13 = new TreeNode<bool>(false);
    ...
    mpttNodes.clear();
    TreeNode<bool> *child2 = new TreeNode<bool>(false);
    ...
    child2 = nullptr;
    mpttNodes.clear();
    TreeNode<bool> *one = new TreeNode<bool>(false);
    TreeNode<bool> *two = new TreeNode<bool>(false);
    TreeNode<bool> *three = new TreeNode<bool>(false);
...
void TestMpttTreeConverter::fromMpttVector()
{
    ...
    try
    {
        // ----------------------------------------
        // Test: empty list
        ITreeNode *tree = converter.fromMpttVector(mpttNodes);
        ...
        // ----------------------------------------
        // Test: duplicate TreeNode<bool> pointer
        rootMptt.left_ = 1;
        rootMptt.right_ = 4;
        ...
        // ----------------------------------------
        // Test: children on root - in the previous test setup, we assigned child1Mptt as a child of root (TreeNode<bool> API)
        rootMptt.left_ = 1;
        rootMptt.right_ = 4;
        child1Mptt.left_ = 2;
        child1Mptt.right_ = 3;
        ...
        child1 = new TreeNode<bool>(false);
        child1Mptt.treeNode_ = child1;
        rootMptt.left_ = 1;
        rootMptt.right_ = 4;
        child1Mptt.left_ = 1;
        ...
        child2Mptt.left_ = 5;
        child2Mptt.right_ = 6;
        TreeNode<bool> *child3 = new TreeNode<bool>(false);
    ...
    //    QVERIFY2(error.message() == "left must be greater than parent left", error.message().toAscii());
        ...
        child1Mptt.left_ = 2;
        child1Mptt.right_ = 5;
        TreeNode<bool> *child11 = new TreeNode<bool>(false);
        ...
        child11 = new TreeNode<bool>(false);
        ...
        child12 = new TreeNode<bool>(false);
        child12Mptt.treeNode_ = child12;
        child12Mptt.left_ = 5;
        child12Mptt.right_ = 6;

        child2 = new TreeNode<bool>(false);
        ...
        child3 = new TreeNode<bool>(false);
