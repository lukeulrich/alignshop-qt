...
#ifndef AMINOMSACOLUMNADAPTER_H
#define AMINOMSACOLUMNADAPTER_H


#include "AbstractColumnAdapter.h"
#include "../../../core/global.h"

class AminoMsaColumnAdapter : public AbstractColumnAdapter
{
    Q_OBJECT
...
public:
    ...
    // ------------------------------------------------------------------------------------------------
    // Constructor
    AminoMsaColumnAdapter(QObject *parent = nullptr);
