...
#ifndef DNASEQCOLUMNADAPTER_H
#define DNASEQCOLUMNADAPTER_H

#include "AbstractColumnAdapter.h"
#include "../../../core/Entities/DnaSeq.h"
#include "../../../core/global.h"

class DnaSeqColumnAdapter : public AbstractColumnAdapter
{
    Q_OBJECT
...
public:
    ...
    // ------------------------------------------------------------------------------------------------
    // Constructor
    explicit DnaSeqColumnAdapter(QObject *parent = nullptr);
