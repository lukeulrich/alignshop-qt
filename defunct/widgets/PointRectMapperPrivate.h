...
public:
    ...
    PointRectMapperPrivate(AbstractMsaView *abstractMsaView);
    ...
    MsaRect canvasRectToMsaRect(const Rect &canvasRect) const;          //!< Returns the MsaRect in msa space that corresponds to canvasRect in canvas space
    MsaRect canvasRectFToMsaRect(const QRectF &canvasRectF) const;      //!< Returns the MsaRect in msa space that corresponds to canvasRectF in canvas space
    ...
    MsaRect viewRectToMsaRect(const QRectF &viewRectF) const;           //!< Returns the MsaRect in msa space that corresponds to viewRectF in view space
    QRectF msaRectToViewRect(const MsaRect &msaRect) const;             //!< Returns the QRectF in view space that corresponds to msaRect in msa space
...
// Canvas <-> Msa Grid
//    QPoint canvasPointToMsaGridPoint(const QPoint &canvasPoint) const;  //!< Returns the QPoint in msa grid space that corresponds to canvasPoint in canvas space
//    QPoint msaGridPointToCanvasPoint(const QPoint &msaGridPoint) const; //!< Returns the QPoint in canvas space that corresponds to msaGridPoint in msa grid space

/**
  * @param canvasPoint [const QPoint &]
  * @returns QPoint
  */
//QPoint PointRectMapperPrivate::canvasPointToMsaGridPoint(const QPoint &canvasPoint) const
//{
//    return QPoint();
//}

/**
  * @param msaGridPoint [const QPoint &]
  * @returns QPoint
  */
//QPoint PointRectMapperPrivate::msaGridPointToCanvasPoint(const QPoint &msaGridPoint) const
//{
//    return QPoint();
//}

//QPointF msaGridPointToViewPoint(const QPoint &msaGridPoint) const;  //!< Returns the QPointF in view space that corresponds to msaGridPoint in msa grid space
//QPoint viewPointToMsaGridPoint(const QPointF &viewPointF) const;    //!< Returns the QPoint in msa grid space that corresponds to viewPointF in view space

/**
  * @param msaGridPoint [const QPoint &]
  * @returns QPointF
  */
//QPointF PointRectMapperPrivate::msaGridPointToViewPoint(const QPoint &msaGridPoint) const
//{
//    return QPointF();
//}
...
/**
  ...
  * @returns QPoint
  */
//QPoint PointRectMapperPrivate::viewPointToMsaGridPoint(const QPointF &viewPointF) const
//{
//    return QPoint();
//}
