...
#include "models/AdocRnaFilterModel.h"

class TestAdocRnaFilterModel : public QObject
{
    Q_OBJECT
...
// ------------------------------------------------------------------------------------------------
// Constructors
void TestAdocRnaFilterModel::constructor()
{
    AdocRnaFilterModel model;

    QObject *qObject = new QObject();
    new AdocRnaFilterModel(qObject);
    delete qObject;
}

void TestAdocRnaFilterModel::isFiltered()
{
    ...
    AdocRnaFilterModel *filter = new AdocRnaFilterModel(this);
    ...
    QVERIFY(filter->data(alpha_index.child(0, 0)) == "s3");
    QVERIFY(filter->data(alpha_index.child(1, 0)) == "ss3");
...
QTEST_MAIN(TestAdocRnaFilterModel)
#include "TestAdocRnaFilterModel.moc"
