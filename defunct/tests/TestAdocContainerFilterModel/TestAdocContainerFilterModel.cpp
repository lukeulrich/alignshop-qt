...
#include "AdocContainerFilterModel.h"

class TestAdocContainerFilterModel : public QObject
{
    Q_OBJECT
...
// ------------------------------------------------------------------------------------------------
// Constructors
void TestAdocContainerFilterModel::constructor()
{
    AdocContainerFilterModel model;

    QObject *qObject = new QObject();
    new AdocContainerFilterModel(qObject);
    delete qObject;
}

void TestAdocContainerFilterModel::isFiltered()
{
    ...
    AdocContainerFilterModel *filter = new AdocContainerFilterModel(this);
...
QTEST_MAIN(TestAdocContainerFilterModel)
#include "TestAdocContainerFilterModel.moc"
